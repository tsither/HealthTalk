...
#### EVAL command  to run spider dataset evaluation file:

# python Personal-Medical-Assistant/backend/evaluation/spider/evaluation.py --gold Personal-Medical-Assistant/backend/evaluation/executable/spider_eval/eval_txts/phi3_gold.txt --pred Personal-Medical-Assistant/backend/evaluation/executable/spider_eval/eval_txts/phi3_pred.txt --etype "all" --db Personal-Medical-Assistant/backend/evaluation/spider/test_database --table Personal-Medical-Assistant/backend/evaluation/spider/evaluation_examples/examples/tables.json
